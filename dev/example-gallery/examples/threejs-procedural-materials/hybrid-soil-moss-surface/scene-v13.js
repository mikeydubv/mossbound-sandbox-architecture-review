...
export default {
  ...
  async setup({ renderer, scene, camera, controls }) {
    ...
    scene.add(worldGrid);
    const buildArea = new THREE.Mesh(new THREE.PlaneGeometry(24,24), new THREE.MeshBasicMaterial({color:0x1d3430, transparent:true, opacity:0.72, depthWrite:false}));
