  ...
  material.onBeforeCompile = (shader) => {
    ...
    shader.fragmentShader = shader.fragmentShader
      ...
      .replace("#include <normal_fragment_maps>", `#include <normal_fragment_maps>
        ...
        roughnessFactor = clamp(sqrt(roughnessFactor * roughnessFactor + max(dot(dFdx(normal), dFdx(normal)), dot(dFdy(normal), dFdy(normal)))), 0.0, 1.0);`);
  };
  material.customProgramCacheKey = () => "soil-moss-v3-specular-aa";
